...
data <- read.csv(file = here("Study 2 Data", "Gratitude_Interventions_Study.csv"))
...
data$ls_total <- rowMeans(data[, c("ls_1", "ls", "ls_3", "ls_4", "ls_5")], na.rm = TRUE)
data$sc_total <- rowMeans(data[, c("sc_1", "sc", "sc_3")], na.rm = TRUE)
