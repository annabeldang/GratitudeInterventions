...
gratitude_data <- data.frame(
  ...
  gratitude_ef = -(c(0, con_1_ef$estimate, con_2_ef$estimate, con_3_ef$estimate, control_1_ef$estimate, control_2_ef$estimate, control_3_ef$estimate, control_4_ef$estimate, control_5_ef$estimate,control_6_ef$estimate,control_7_ef$estimate)))
...
# Plot the graph
gratitude_graph_2 <- ggplot(gratitude_data, aes(x = ordered_condition_name, y = gratitude_mean, fill = ordered_condition_color)) +
...
happy_mean <- tapply(data$happy_all, data$condition, mean) - 3.996053
...
happy_data <- data.frame(
  ...
  happy_se = happy_se,
  happy_ef = -(c(0, con_1_ef$estimate, con_2_ef$estimate, con_3_ef$estimate, control_1_ef$estimate, control_2_ef$estimate, control_3_ef$estimate, control_4_ef$estimate, control_5_ef$estimate,control_6_ef$estimate,control_7_ef$estimate))
)
...
# Plot the graph
happy_graph_2 <- ggplot(happy_data, aes(x = ordered_condition_name, y = happy_mean, fill = ordered_condition_color)) +
  geom_bar(stat = "identity") +
...
sad_data <- data.frame(
  ...
  sad_mean = sad_mean,
  sad_se = sad_se,
  sad_ef = -(c(0, con_1_ef$estimate, con_2_ef$estimate, con_3_ef$estimate, control_1_ef$estimate, control_2_ef$estimate, control_3_ef$estimate, control_4_ef$estimate, control_5_ef$estimate,control_6_ef$estimate,control_7_ef$estimate))
)
...
# Plot the graph
sad_graph_2 <- ggplot(sad_data, aes(x = ordered_condition_name, y = sad_mean, fill = ordered_condition_color)) +
  geom_bar(stat = "identity") +
...
ls_data <- data.frame(
  ...
  ls_mean = ls_mean,
  ls_se = ls_se,
  ls_ef = -(c(0, con_1_ef$estimate, con_2_ef$estimate, con_3_ef$estimate, control_1_ef$estimate, control_2_ef$estimate, control_3_ef$estimate, control_4_ef$estimate, control_5_ef$estimate,control_6_ef$estimate,control_7_ef$estimate))
)
...
ls_graph_2 <- ggplot(ls_data, aes(x = ordered_condition_name, y = ls_mean, fill = ordered_condition_color)) +
  geom_bar(stat = "identity") +
  ...
  guides(fill = guide_legend(title = "Condition")) +
  scale_y_continuous(labels = scales::number_format(accuracy = 0.1, decimal.mark = ".", scale = 1),
                     sec.axis = sec_axis(~ rescale(., from = ls_y_range, to = ls_effect_size_range),
                                         name = "Effect Size",  
                                         labels = scales::number_format(accuracy = 0.1, decimal.mark = ".", scale = 1))) +
...
#PA
combined_graph_pa <- happy_graph + theme_settings + theme(legend.position = "none") +
  happy_graph_2 + theme_settings + theme(legend.position = "right")

print(combined_graph_pa)
