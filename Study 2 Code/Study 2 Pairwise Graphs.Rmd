...
=======
# specify directory
i_am("Study 2 Code/Study 2 Pairwise Graphs.Rmd")
...
# process data
data_2 <- read.csv("Gratitude_Interventions_Study_2.csv")
  # remove incomplete or test observations
data_2 <- data_2[data_2$Finished == 1, ]
...
combined_plot <- (
  (gratitude_graph_2 + theme_settings + theme(legend.position = "none")) +
  (happy_graph_2 + theme_settings + theme(legend.position = "none")) +
  (sad_graph_2 + theme_settings + theme(legend.position = "none")) +
