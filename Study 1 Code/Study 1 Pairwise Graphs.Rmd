...
gratitude_scaled_effect_sizes <- scales::rescale(gratitude_data$gratitude_ef, 
                                                  to = gratitude_y_range)
```
```{r gratitude graph}
...
gratitude_graph <- ggplot(gratitude_data, aes(x = ordered_condition_name, y = gratitude_mean, fill = ordered_condition_color)) +
  ...
  scale_y_continuous(labels = scales::number_format(accuracy = 0.1),
                     sec.axis = sec_axis(trans = ~ ( . - min(gratitude_y_range)) / diff(gratitude_y_range) * diff(gratitude_effect_size_range) + min(gratitude_effect_size_range),
                                         name = "Effect Size", 
...
# Scale effect sizes to match y-axis range
happy_scaled_effect_sizes <- scales::rescale(happy_data$happy_ef, 
                                                  to = happy_y_range)
```
```{r happy graph}
...
happy_graph <- ggplot(happy_data, aes(x = ordered_condition_name, y = happy_mean, fill = ordered_condition_color)) +
  ...
  scale_y_continuous(labels = scales::number_format(accuracy = 0.1),
                     sec.axis = sec_axis(trans = ~ ( . - min(happy_y_range)) / diff(happy_y_range) * diff(happy_effect_size_range) + min(happy_effect_size_range),
                                         name = "Effect Size", 
                                         labels = scales::number_format(accuracy = 0.1))) + 
...
# Scale effect sizes to match y-axis range
sad_scaled_effect_sizes <- scales::rescale(sad_data$sad_ef, 
                                                  to = sad_y_range)
```
```{r sad graph}
...
sad_graph <- ggplot(sad_data, aes(x = ordered_condition_name, y = sad_mean, fill = ordered_condition_color)) +
  ...
  guides(fill = guide_legend(title = "Condition",                              override.aes = list(color = "black", size = 1))) +
  scale_y_continuous(labels = scales::number_format(accuracy = 0.1),
                     sec.axis = sec_axis(trans = ~ ( . - min(sad_y_range)) / diff(sad_y_range) * diff(sad_effect_size_range) + min(sad_effect_size_range),
                                         name = "Effect Size", 
                                         labels = scales::number_format(accuracy = 0.1))) + 
  
  geom_segment(aes(x = 0.5, xend = 5.5, y = 0.6, yend = 0.6), color = "black", size = 0.5) +
  geom_segment(aes(x = 0.5, xend = 0.5, y = 0.55, yend = 0.6), color = "black", size = 0.5) +
  geom_segment(aes(x = 5.5, xend = 5.5, y = 0.55, yend = 0.6), color = "black", size = 0.5) +
  geom_segment(aes(x = 5.5, xend = 8.5, y = 0.575, yend = 0.575), color = "black", size = 0.5) + 
  geom_text(aes(x = 7, y = 0.6), label = "*", color = "black", size = 5) +
  geom_segment(aes(x = 8.5, xend = 9.5, y = 0.6, yend = 0.6), color = "black", size = 0.5) + 
  geom_segment(aes(x = 8.5, xend = 8.5, y = 0.55, yend = 0.6), color = "black", size = 0.5) +
  geom_segment(aes(x = 9.5, xend = 9.5, y = 0.55, yend = 0.6), color = "black", size = 0.5) +
  
  geom_segment(aes(x = 0.5, xend = 4.5, y = 0.7, yend = 0.7), color = "black", size = 0.5) +
  geom_segment(aes(x = 0.5, xend = 0.5, y = 0.65, yend = 0.7), color = "black", size = 0.5) +
  geom_segment(aes(x = 4.5, xend = 4.5, y = 0.65, yend = 0.7), color = "black", size = 0.5) +
  geom_segment(aes(x = 4.5, xend = 6.5, y = 0.675, yend = 0.675), color = "black", size = 0.5) + 
  geom_text(aes(x = 5.5, y = 0.7), label = "*", color = "black", size = 5) +
  geom_segment(aes(x = 6.5, xend = 9.5, y = 0.7, yend = 0.7), color = "black", size = 0.5) + 
  geom_segment(aes(x = 6.5, xend = 6.5, y = 0.65, yend = 0.7), color = "black", size = 0.5) +
  geom_segment(aes(x = 9.5, xend = 9.5, y = 0.65, yend = 0.7), color = "black", size = 0.5) +

geom_segment(aes(x = 0.5, xend = 3.5, y = 0.8, yend = 0.8), color = "black", size = 0.5) +
  geom_segment(aes(x = 0.5, xend = 0.5, y = 0.75, yend = 0.8), color = "black", size = 0.5) +
  geom_segment(aes(x = 3.5, xend = 3.5, y = 0.75, yend = 0.8), color = "black", size = 0.5) +
  geom_segment(aes(x = 3.5, xend = 5.5, y = 0.775, yend = 0.775), color = "black", size = 0.5) + 
  geom_text(aes(x = 4.5, y = 0.8), label = "*", color = "black", size = 5) +
  geom_segment(aes(x = 5.5, xend = 9.5, y = 0.8, yend = 0.8), color = "black", size = 0.5) + 
  geom_segment(aes(x = 5.5, xend = 5.5, y = 0.75, yend = 0.8), color = "black", size = 0.5) +
  geom_segment(aes(x = 9.5, xend = 9.5, y = 0.75, yend = 0.8), color = "black", size = 0.5)
...
# Scale effect sizes to match y-axis range
ls_scaled_effect_sizes <- scales::rescale(ls_data$ls_ef, 
                                                  to = ls_y_range)
```
```{r ls graph}
...
ls_graph <- ggplot(ls_data, aes(x = ordered_condition_name, y = ls_mean, fill = ordered_condition_color)) +
  ...
  guides(fill = guide_legend(title = "Condition",                              override.aes = list(color = "black", size = 1))) +
  scale_y_continuous(labels = scales::number_format(accuracy = 0.1),
                     sec.axis = sec_axis(trans = ~ ( . - min(ls_y_range)) / diff(ls_y_range) * diff(ls_effect_size_range) + min(ls_effect_size_range),
                                         name = "Effect Size", 
                                         labels = scales::number_format(accuracy = 0.1))) + 
