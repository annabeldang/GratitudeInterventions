...
gratitude_graph <- ggplot(gratitude_data, aes(x = ordered_condition_name, y = gratitude_mean, fill = ordered_condition_color)) +
  ...
  geom_text(aes(x = 1.45, y = 2.03), label = "*", color = "red", size = 5) +
  ...
  geom_text(aes(x = 2.45, y = 2.23), label = "*", color = "red", size = 5)+
  ...
  geom_text(aes(x = 4.45, y = 2.43), label = "*", color = "red", size = 5)+
  ...
  geom_text(aes(x = 8, y = 2.58), label = "*", color = "red", size = 5) +
...
happy_graph <- ggplot(happy_data, aes(x = ordered_condition_name, y = happy_mean, fill = ordered_condition_color)) +
  ...
  geom_text(aes(x = 3.5, y = 1.38), label = "*", color = "red", size = 5) +
...
sad_graph <- ggplot(sad_data, aes(x = ordered_condition_name, y = sad_mean, fill = ordered_condition_color)) +
  ...
  geom_text(aes(x = 7, y = 0.55), label = "*", color = "red", size = 5) +
...
geom_segment(aes(x = 0.5, xend = 3.5, y = 0.75, yend = 0.75), color = "black", size = 0.5) +
  ...
  geom_text(aes(x = 4.5, y = 0.75), label = "*", color = "red", size = 5) +
...
ls_graph <- ggplot(ls_data, aes(x = ordered_condition_name, y = ls_mean, fill = ordered_condition_color)) +
  ...
  geom_text(aes(x = 3.5, y = 0.55), label = "*", color = "red", size = 5) +
  ...
  geom_text(aes(x = 5, y = 0.65), label = "*", color = "red", size = 5)+
  ...
  geom_text(aes(x = 6, y = 0.75), label = "*", color = "red", size = 5)+
