...
gratitude_graph <- ggplot(gratitude_data, aes(x = ordered_condition_name, y = gratitude_mean, fill = ordered_condition_color)) +
  ...
  geom_line(aes(y = gratitude_scaled_effect_sizes), color = "red") +
  labs(x = "Conditions",
       y = "Mean Self-Reported Gratitude",
       title = "Mean Gratitude across Conditions") +
  ylim(-0.5, 1.5) + 
  theme_minimal() +
  ...
  geom_segment(aes(x = 2.5, xend = 3.5, y = 1.95, yend = 1.95), color = "black", size = 0.5) +
  geom_text(aes(x = 3, y = 1.98), label = "*", color = "red", size = 5) +
  geom_segment(aes(x = 3.5, xend = 9.5, y = 2.0, yend = 2.0), color = "black", size = 0.5) +
  geom_segment(aes(x = 3.5, xend = 3.5, y = 1.9, yend = 2.0), color = "black", size = 0.5) +
  geom_segment(aes(x = 9.5, xend = 9.5, y = 1.9, yend = 2.0), color = "black", size = 0.5) +
  
  geom_segment(aes(x = 0.5, xend = 4.4, y = 2.2, yend = 2.2), color = "black", size = 0.5) +
  geom_segment(aes(x = 0.5, xend = 0.5, y = 2.1, yend = 2.2), color = "black", size = 0.5) +
  geom_segment(aes(x = 4.4, xend = 4.4, y = 2.1, yend = 2.2), color = "black", size = 0.5) +
  geom_segment(aes(x = 4.4, xend = 4.50, y = 2.15, yend = 2.15), color = "black", size = 0.5) +
  geom_text(aes(x = 4.45, y = 2.23), label = "*", color = "red", size = 5)+
  geom_segment(aes(x = 4.50, xend = 9.5, y = 2.2, yend = 2.2), color = "black", size = 0.5) +
  geom_segment(aes(x = 4.50, xend = 4.50, y = 2.1, yend = 2.2), color = "black", size = 0.5) +
  geom_segment(aes(x = 9.5, xend = 9.5, y = 2.1, yend = 2.2), color = "black", size = 0.5) +
  
  geom_segment(aes(x = 0.5, xend = 7.5, y = 2.4, yend = 2.4), color = "black", size = 0.5) + 
  geom_segment(aes(x = 0.5, xend = 0.5, y = 2.3, yend = 2.4), color = "black", size = 0.5) +
  geom_segment(aes(x = 7.5, xend = 7.5, y = 2.3, yend = 2.4), color = "black", size = 0.5) +
  geom_segment(aes(x = 7.5, xend = 8.5, y = 2.35, yend = 2.35), color = "black", size = 0.5) + 
  geom_text(aes(x = 8, y = 2.38), label = "*", color = "red", size = 5) +
  geom_segment(aes(x = 8.5, xend = 9.5, y = 2.4, yend = 2.4), color = "black", size = 0.5) +
  geom_segment(aes(x = 8.5, xend = 8.5, y = 2.3, yend = 2.4), color = "black", size = 0.5) +
...
happy_graph <- ggplot(happy_data, aes(x = ordered_condition_name, y = happy_mean, fill = ordered_condition_color)) +
  ...
  geom_errorbar(aes(ymin = happy_mean - happy_se, 
                ...
                width = 0.2, position = position_dodge(0.9)) + 
  geom_line(aes(y = happy_scaled_effect_sizes), color = "red") +  # Line for effect sizes
  labs(x = "Conditions",
       y = "Mean Self-Reported PA",
       title = "Mean PA across Conditions") +
  ylim(-0.5, 2) + 
  theme_minimal() +
   theme(plot.title = element_text(hjust = 0.5),
        axis.text.x = element_blank(),
  ...
  geom_segment(aes(x = 2.5, xend = 3.5, y = 1.35, yend = 1.35), color = "black", size = 0.5) +
  geom_text(aes(x = 3, y = 1.38), label = "*", color = "red", size = 5) +
  geom_segment(aes(x = 3.5, xend = 9.5, y = 1.4, yend = 1.4), color = "black", size = 0.5) +
  ...
  geom_text(aes(x = 4, y = 1.58), label = "*", color = "red", size = 5)+
  ...
  geom_text(aes(x = 6, y = 1.78), label = "*", color = "red", size = 5)+
...
sad_graph <- ggplot(sad_data, aes(x = ordered_condition_name, y = sad_mean, fill = ordered_condition_color)) +
  ...
  geom_errorbar(aes(ymin = sad_mean - sad_se, 
                ...
                width = 0.2, position = position_dodge(0.9)) + 
  geom_line(aes(y = sad_scaled_effect_sizes), color = "red") +  # Line for effect sizes
  labs(x = "Conditions",
       y = "Mean Self-Reported NA",
       title = "Mean NA across Conditions") +
  ylim(-0.5, 2) + 
  theme_minimal() +
    theme(plot.title = element_text(hjust = 0.5),
        axis.text.x = element_blank(),
  ...
  geom_text(aes(x = 7, y = 0.53), label = "*", color = "red", size = 5) +
  ...
  geom_text(aes(x = 5.5, y = 0.63), label = "*", color = "red", size = 5) +
...
geom_segment(aes(x = 0.5, xend = 3.5, y = 0.75, yend = 0.75), color = "black", size = 0.5) +
  ...
  geom_text(aes(x = 4.5, y = 0.73), label = "*", color = "red", size = 5) +
...
ls_graph <- ggplot(ls_data, aes(x = ordered_condition_name, y = ls_mean, fill = ordered_condition_color)) +
  ...
  geom_errorbar(aes(ymin = ls_mean - ls_se, 
                    ymax = ls_mean + ls_se),
                width = 0.2, position = position_dodge(0.9)) + 
  geom_line(aes(y = ls_scaled_effect_sizes), color = "red") +  # Line for effect sizes
  labs(x = "Conditions",
       y = "Mean Self-Reported Life Satisfaction",
       title = "Mean Life Satisfaction across Conditions") +
  ylim(-0.5, 2) + 
  theme_minimal() +
    theme(plot.title = element_text(hjust = 0.5),
        axis.text.x = element_blank(),
  ...
  geom_segment(aes(x = 1.5, xend = 3.5, y = 0.525, yend = 0.525), color = "black", size = 0.5) + 
  geom_text(aes(x = 2.5, y = 0.53), label = "*", color = "red", size = 5) +
  geom_segment(aes(x = 3.5, xend = 9.5, y = 0.55, yend = 0.55), color = "black", size = 0.5) + 
  geom_segment(aes(x = 3.5, xend = 3.5, y = 0.5, yend = 0.55), color = "black", size = 0.5) +
  geom_segment(aes(x = 9.5, xend = 9.5, y = 0.5, yend = 0.55), color = "black", size = 0.5) +
  ...
  geom_text(aes(x = 5, y = 0.63), label = "*", color = "red", size = 5)+
  ...
  geom_text(aes(x = 6, y = 0.73), label = "*", color = "red", size = 5)+
